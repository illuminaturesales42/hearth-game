...
export class MinigameUI {
  ...
  /**
   * Paint the game's backdrop behind the card if its art has been sliced
   * (mg_bg_<game>); otherwise leave the flat panel. Fallback-guarded so the
   * scene lights up the moment the asset lands, with no code change.
   */
