...
export const ALMANAC_PAGES: readonly AlmanacPage[] = [
  // Joss's Catch + Beacon Drop — the fish come from the water either way
  {
    ...
    section: 'The Water',
    name: 'Silver Smelt',
    note: 'Small, quick, and enough for the pot.',
  },
  {
    id: 'fish_1',
    chain: 'fish',
    ...
    section: 'The Water',
    name: 'Harbour Bream',
    note: 'The everyday fish of Emberhollow’s bay.',
  },
  {
    id: 'fish_2',
    chain: 'fish',
    ...
    section: 'The Water',
    name: 'Beacon Trout',
    note: 'Drawn in by lantern light, Joss swears.',
  },
  {
    id: 'fish_3',
    chain: 'fish',
  ...
  // The forge
  {
    ...
    section: 'The Forge',
    name: 'Raw Ore',
    note: 'Straight from the hillside, still cold.',
  },
  {
    id: 'copper_1',
    chain: 'copper',
    ...
    section: 'The Forge',
    name: 'Rough Copper',
    note: 'Honest work, honestly struck.',
  },
  {
    id: 'copper_2',
    chain: 'copper',
    ...
    section: 'The Forge',
    name: 'Bright Bar',
    note: 'Struck true on the sweet heat.',
  },
  {
    id: 'copper_3',
    chain: 'copper',
    level: 3,
    section: 'The Forge',
    name: 'Masterwork Copper',
    note: 'Every strike on the glow. The anvil sang.',
  },
  // The sawmill
  {
    id: 'wood_1',
    ...
    section: 'The Sawmill',
    name: 'Billet',
    note: 'The flume ran; the timber stacked.',
  },
  { id: 'wood_2', chain: 'wood', level: 2, section: 'The Sawmill', name: 'Plank', note: 'A good day’s milling.' },
  {
    ...
    section: 'The Sawmill',
    name: 'Rafter Beam',
    note: 'Sawn clean to the song’s last note.',
  },
  // The well
  { id: 'seeds_0', chain: 'seeds', level: 0, section: 'The Well', name: 'Stray Seed', note: 'A wish, lightly made.' },
  {
    ...
    section: 'The Well',
    name: 'Rooted Wish',
    note: 'It took, in its own quiet way.',
  },
  {
    id: 'seeds_2',
    chain: 'seeds',
    ...
    section: 'The Well',
    name: 'Fine Seedling',
    note: 'The centre ring, and a wish worth keeping.',
  },
  {
    id: 'seeds_3',
    chain: 'seeds',
    level: 3,
    section: 'The Well',
    name: 'Deep-Rooted Wish',
    note: 'Three true drops. The well remembered.',
  },
  // The library
  {
    id: 'books_1',
  ...
  },
  {
    ...
    section: 'The Library',
    name: 'The Rare Folio',
    note: 'Five shelves from memory alone.',
  },
  // The foraging expedition
  {
    ...
    chain: 'herbs',
    level: 0,
    section: 'The Coast Path',
    name: 'Wild Herbs',
    note: 'Found underfoot, if you look.',
  },
  {
    id: 'herbs_1',
    chain: 'herbs',
    ...
    section: 'The Coast Path',
    name: 'Sea Rosemary',
    note: 'Grows where the salt wind reaches.',
  },
  {
    id: 'flowers_0',
    chain: 'flowers',
  ...
  },
  {
    ...
    section: 'The Coast Path',
    name: 'The Honeycomb',
    note: 'The prize of the coast path — found by warmth alone.',
  },
];
