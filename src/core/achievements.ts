...
export const ACHIEVEMENTS: readonly AchievementDef[] = [
  ...
  },
  {
    id: 'first-order',
    art: 'badge_event_6',
    title: 'A Neighbour Helped',
    desc: 'Deliver your first order.',
    icon: '⭐',
    coins: 30,
  ...
  },
  {
    ...
    icon: '🌷',
    coins: 800,
    earned: (s) => s.orderIndex >= 72,
  },
  {
    id: 'streak-7',
    art: 'badge_habit_hero',
    title: 'Keeper of the Flame',
    desc: 'Tend the hearth 7 days running.',
    icon: '🔥',
    coins: 100,
  ...
  },
  {
    id: 'first-duel-win',
    art: 'badge_event_7',
    title: 'Bonfire Champion',
    desc: 'Win a Bonfire Duel.',
    icon: '⚔️',
    coins: 60,
  ...
  {
    id: 'town-half',
    art: 'badge_master_builder',
    title: 'Half the Lights On',
    desc: 'Restore half of Emberhollow.',
    icon: '🏘️',
    coins: 120,
    earned: (s) => s.orderIndex >= 12,
  },
  {
    id: 'town-full',
    art: 'badge_hearth_guardian',
    title: 'Beacon of Emberhollow',
    desc: 'Restore the whole village.',
    icon: '🌟',
    coins: 300,
    earned: (s) => s.orderIndex >= 24,
  },
  {
    id: 'first-flashback',
    art: 'badge_event_5',
    title: 'A Good Day, Remembered',
    desc: 'Hold onto a resurfaced memory.',
    icon: '📖',
    coins: 40,
  ...
  {
    id: 'merges-100',
    art: 'badge_merge_master',
    title: 'Hundred Hands',
    desc: 'Make 100 merges.',
    icon: '🔨',
    coins: 100,
