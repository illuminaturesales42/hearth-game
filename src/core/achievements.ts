...
export const ACHIEVEMENTS: readonly AchievementDef[] = [
  ...
  { id: 'ch4-complete', art: 'badge_event_1', title: 'New Sails', desc: 'Complete Chapter 4.', icon: '⛵', coins: 500,
    earned: (s) => s.orderIndex >= 48 },
  { id: 'ch5-complete', art: 'badge_event_2', title: 'The Long Winter', desc: 'Complete Chapter 5.', icon: '❄️', coins: 600,
    earned: (s) => s.orderIndex >= 60 },
  { id: 'ch6-complete', art: 'badge_event_6', title: 'Spring Tides', desc: 'Complete Chapter 6.', icon: '🌷', coins: 800,
