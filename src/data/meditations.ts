...
export const MEDITATIONS: readonly Meditation[] = [
  {
    id: 'med-morning', title: 'Morning Calm', sublabel: 'Ease into the day',
    durationSec: 180, inhaleSec: 4, holdSec: 2, exhaleSec: 6, holdOutSec: 0,
    energy: 10, timesPerDay: 1,
  },
  {
    id: 'med-box', title: 'Box Breathing', sublabel: 'Steady the mind, anytime',
    durationSec: 120, inhaleSec: 4, holdSec: 4, exhaleSec: 4, holdOutSec: 4,
    energy: 8, timesPerDay: 2,
  },
  {
    id: 'med-478', title: '4·7·8 Wind-down', sublabel: 'For the evening',
    durationSec: 180, inhaleSec: 4, holdSec: 7, exhaleSec: 8, holdOutSec: 0,
    energy: 12, timesPerDay: 1,
  },
  {
    id: 'med-bodyscan', title: 'Body Scan', sublabel: 'Release the whole day',
    durationSec: 300, inhaleSec: 5, holdSec: 0, exhaleSec: 7, holdOutSec: 0,
    energy: 16, timesPerDay: 1,
  },
] as const;
