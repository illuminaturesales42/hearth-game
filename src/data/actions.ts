...
export const ACTIONS: readonly EnergyAction[] = [
  ...
  {
    id: 'steps',
    label: 'Walk the Coast Road',
    sublabel: '10,000 steps, counted as you walk · +5 past 12k',
    icon: '👟',
    energy: 20,
    timesPerDay: 1,
    kind: 'sensor',
  ...
  {
    id: 'stairs',
    label: 'Climb the Cliff Steps',
    sublabel: 'Flights of stairs climbed',
    icon: '🪜',
    energy: 10,
    timesPerDay: 1,
    kind: 'sensor',
  ...
  },
  {
    ...
    sublabel: 'A full 8 hours of sleep · 7h earns +10',
    icon: '😴',
    energy: 20,
    timesPerDay: 1,
    kind: 'sensor',
  ...
  // ---- self-report (honour system, small caps) ----
  {
    id: 'water',
    label: 'Fill the Well',
    sublabel: 'Drink water through the day (1.5L)',
    icon: '💧',
    energy: 10,
    timesPerDay: 1,
    kind: 'selfReport',
  ...
  // ---- photo (camera) ----
  {
    id: 'photo-outside',
    label: 'Find Beauty',
    sublabel: 'Take a photo outdoors',
    icon: '📷',
    energy: 10,
    timesPerDay: 1,
    kind: 'photo',
    featured: true,
    photoPrompt: 'Point at anything outdoors',
    photoWindow: 'day',
  },
  ...
  {
    id: 'sunrise-photo',
    label: 'Welcome the Morning',
    sublabel: 'Photograph the sunrise · only at first light',
    icon: '🌅',
    energy: 15,
    timesPerDay: 1,
    kind: 'photo',
    featured: false,
    photoPrompt: 'Catch the sunrise',
    photoWindow: 'sunrise',
  },
  {
    id: 'sunset-photo',
    label: 'Bid the Sun Goodnight',
    sublabel: 'Photograph the sunset · only as the light goes',
    icon: '🌇',
    energy: 15,
    timesPerDay: 1,
    kind: 'photo',
    featured: false,
    photoPrompt: 'Catch the sunset',
    photoWindow: 'sunset',
  },
  {
    id: 'nature-photo',
    label: 'Seek the Wild',
    sublabel: 'Find something green — a tree, a plant, the sea',
    icon: '🌿',
    energy: 10,
    timesPerDay: 1,
    kind: 'photo',
    featured: false,
    photoPrompt: 'Point at something living',
    photoWindow: 'day',
  },
  {
    id: 'stretch',
    label: 'Wake the Garden',
    sublabel: 'A morning stretch',
    icon: '🧘',
    energy: 8,
    timesPerDay: 1,
    kind: 'motion',
  ...
  {
    id: 'breathe',
    label: 'Catch the Sea Breeze',
    sublabel: 'Four slow breaths, in for four out for four',
    icon: '🌬️',
    energy: 6,
    timesPerDay: 2,
    kind: 'motion',
