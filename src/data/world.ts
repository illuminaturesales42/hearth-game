...
export const MAP_LOCATIONS: readonly MapLocation[] = [
  {
    ...
    unlockAt: 0,
    level: 2,
    blurb: 'Dark for seventeen years. Lit again on the night the letter came.',
  },
  {
    id: 'bakers-row',
    name: "Baker's Row",
    unlockAt: 0,
    level: 3,
    blurb: "Bran's ovens and the notice board that started all of this.",
  },
  {
    id: 'market',
    name: 'Market Square',
    unlockAt: 3,
    level: 2,
    blurb: 'Lamplight, gossip, and Wren behind the post counter.',
  },
  {
    id: 'pier',
    ...
    unlockAt: 6,
    level: 2,
    blurb: 'Where a rowboat was hauled up above the tideline. Recently.',
  },
  {
    id: 'north-docks',
    name: 'North Docks',
    unlockAt: 9,
    level: 1,
    blurb: 'The way to the shoals and the circled cove.',
  },
  {
    id: 'quarry',
    name: 'Old Quarry',
    unlockAt: 12,
    level: 1,
    blurb: 'Sorin says the shuttering bolt was cut here. Chapter 2 opens the gate.',
  },
];
...
export const JOURNAL: readonly JournalEntry[] = [
  {
    ...
    at: 1,
    note: 'Pinned dead centre: a letter addressed to nobody, postmarked seventeen years ago.',
  },
  {
    id: 'j-key',
    tab: 'Clues',
    title: 'The Brass Key',
    at: 2,
    note: 'Found in the oven flue, with a warning: "Don’t trust the lighthouse keeper."',
  },
  {
    id: 'j-future',
    tab: 'Letters',
    title: 'The Impossible Letter',
    at: 3,
    note: 'Dated three days from now. Wren read it twice and folded it fast.',
  },
  {
    id: 'j-bolt',
    tab: 'Clues',
    title: 'The Lighthouse Bolt',
    at: 5,
    note: 'Sorin kept the bolt used to shutter the light. The light was hidden on purpose.',
  },
  {
    id: 'j-nine',
    tab: 'Letters',
    title: 'Nine Letters in Her Hand',
    at: 7,
    note: 'All postmarked after the day Marta vanished.',
  },
  {
    id: 'j-cove',
    tab: 'Places',
    title: 'The Northern Cove',
    at: 8,
    note: 'Circled twice on Marta’s oilskin chart, behind the black rocks.',
  },
  {
    id: 'j-boat',
    tab: 'Clues',
    title: 'The Rowboat',
    at: 9,
    note: 'Hauled above the tideline near the northern cove. Recently used.',
  },
  {
    id: 'j-marta',
    tab: 'People',
    title: 'Marta',
    at: 11,
    note: 'Presumed drowned seventeen years ago. She rowed north instead. Now home — but why the letters?',
  },
  {
    id: 'j-letter11',
    tab: 'Letters',
    ...
    at: 12,
    note: 'Unread. It sits on the cottage windowsill, in Marta’s hand.',
    fresh: true,
  },
  {
    id: 'j-bootprints',
    ...
    at: 13,
    note: 'Lantern-light caught them leading to the north cove. Someone walks there at night.',
  },
  {
    id: 'j-marigold',
    tab: 'Clues',
    title: 'The Marigold',
    at: 15,
    note: 'A rusted coin from a ship of that name, hidden under Sorin’s old bench.',
  },
  {
    id: 'j-yesterday',
    tab: 'Letters',
    title: 'Postmarked Yesterday',
    at: 16,
    note: 'A letter addressed to Marta — dated after her return. Someone is still writing.',
  },
  {
    id: 'j-joss',
    tab: 'People',
    title: 'Fisher Joss',
    at: 18,
    note: 'Boatswain of the strange tides. Pulled a torn oilskin from the nets, stitched A.V.',
  },
  {
    id: 'j-tidechart',
    tab: 'Clues',
    ...
    at: 19,
    note: 'Hidden markings in the desk drawer. The shoals were mapped by someone patient.',
  },
  {
    id: 'j-aldenvale',
    tab: 'People',
