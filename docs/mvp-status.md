...
8. Villagers → **Bonfire Duel**: hot-seat match; win banks the board to the Repository → "Deliver to Emberhollow".
...
- Friends/gifts are a **local simulation**; duel is hot-seat. Online backend is post-MVP (M3 of the original plan).
